(function () {
  ...
  if (!lightbox) {
    ...
    lightbox.innerHTML = '<button type="button" aria-label="Close gallery image">X</button><img alt="">';
  ...
  document.querySelectorAll("[data-contact-form]").forEach((form) => {
    ...
    form.addEventListener("submit", (event) => {
      ...
      status.textContent = "Opening WhatsApp with your message. If it does not open, email info@amazonadventurelodge.com.";
